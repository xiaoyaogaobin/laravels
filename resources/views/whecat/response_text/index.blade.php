                ...
                <div class="card-body">
                    <div class="row align-items-center text-center">
                        <div class="col">
                            ...
                            <!-- Heading -->
                           <a href ="{{route('wechat.response_text.create')}}">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <!-- Button -->
                            <a href="{{route('wechat.response_text.create')}}" class="btn btn-sm btn-success	DUE DATE 	DUE DATE ">
                                +添加新回复
                            </a>
                        ...
                        <tr>
                            ...
                            <td class="goal-date">
                                <div class="button-group">
                                    <a href="{{route('wechat.response_text.edit',$field)}}">
                                    ...
                                    <form action="{{route('wechat.response_text.destroy',$field)}}" id="del" method="post">
                                        @csrf @method('DELETE')
                                    </form>
                                </div>
                            </td>
