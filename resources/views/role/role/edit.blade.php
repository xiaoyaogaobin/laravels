                        ...
                        <div class="card-body">
                            <form action="{{route('role.role.update',$role)}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="title"  value="{{$role['title']}}" class="form-control" id="inputEmail3" placeholder="栏目名称">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">角色英文</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="name" value="{{$role['name']}}"class="form-control" id="inputEmail3" placeholder="栏目名称">
                                    </div>
                                </div>


                                <button  class="btn btn-success">角色修改</button>
                            </form>
