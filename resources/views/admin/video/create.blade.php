            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <!-- Button -->
                            <a href="{{route('admin.column.index')}}" class="btn btn-sm btn-success">
                                返回栏目
                            </a>
                ...
                <div class="table-responsive mb-0" data-toggle="lists" data-lists-values='["goal-project", "goal-status", "goal-progress", "goal-date"]'>
                    <div class=" text-center">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.column.store')}}" method="post">
                                @csrf
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text fa fa-hand-grab-o fa-balance-scale" id="icon"></span>
                                            </div>
