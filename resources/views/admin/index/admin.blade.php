                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            ...
                            <!-- Avatar -->
                            <a href="project-overview.html" class="avatar avatar-4by3">
                                <img src="{{asset('org/disk/assets')}}/img/avatars/projects/project-5.jpg" alt="..." class="avatar-img rounded">
                            </a>
                            ...
                            <td class="text-right">
                                <div class="avatar-group">
                                    <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="Dianna Smiley">
                                        <img src="{{asset('org/disk/assets')}}/img/avatars/profiles/avatar-1.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                    </a>
                                    <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="Ab Hadley">
                                        <img src="{{asset('org/disk/assets')}}/img/avatars/profiles/avatar-2.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                    </a>
                                    <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="Adolfo Hess">
                                        <img src="{{asset('org/disk/assets')}}/img/avatars/profiles/avatar-3.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                    </a>
                                    <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="Daniela Dewitt">
                                        <img src="{{asset('org/disk/assets')}}/img/avatars/profiles/avatar-4.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                    </a>
                                </div>
                            </td>
                            <td class="text-right">
