    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10 col-xl-8">
                ...
                <!-- Form -->
                <form class="mb-4" method="post" action="{{route('article.article.update',$article)}}">
                @csrf @method('PUT')
                <!-- Project name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-1">
                            <input class="form-control  form-control-sm" name="background" readonly="" value="{{$article->background}}">
                        ...
                        <div style="display: inline-block;position: relative;">
                            <img src="{{$article->background}}" class="img-responsive img-thumbnail" width="150">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control "  data-toggle="select" data-minimum-results-for-search="-1" name="category_id">
                            ...
                            @foreach($gategorie as $v)
                                <option @if('$article->category_id == $v->id')selected @endif value="{{$v->id}}">
                                    {{$v->title}}
                                </option>
                            @endforeach
                        </select>
